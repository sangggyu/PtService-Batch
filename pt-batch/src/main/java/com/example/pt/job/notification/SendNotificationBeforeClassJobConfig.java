package com.example.pt.job.notification;

import com.example.pt.repository.booking.BookingEntity;
import com.example.pt.repository.notification.NotificationEntity;
import com.example.pt.repository.notification.NotificationEvent;
import com.example.pt.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    public SynchronizedItemStreamReader<NotificationEntity> sendNotificationItemReader(){
        // 이벤트가 수업 전, 발송 여부가 미발송인 알람이 조회 대상
